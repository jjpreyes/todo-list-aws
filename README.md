...
## [2023.05.22]: Comentarios JJ
## Levantar el docker, comprobar que está arriba y crear la tabla local
## con esto ya es suficiente para poder acceder a dynamodb una vez el docker se haya creado
...
## [2023.05.22]: Comentarios JJ
## Para evitar los problemas de Python y la liberería urllib3 se debe hacer el build de la siguiente forma
